...
const paths = [
  ...
  },
  {
    ...
    notes:
      "Escursione facile. Adatto ad ogni livello di allenamento. Sentieri facilmente percorribili. Adatto ad ogni livello di abilità.",
    time: "55m",
    totDistance: "3.1km",
    posElevation: "210m",
    negElevation: "25m",
  ...
  },
  {
    ...
    notes:
      "Escursione di difficoltà media. Sentieri facilmente percorribili. Non presenta particolari difficoltà se non la lunghezza del percorso.",
    time: "3h 30m",
    totDistance: "13.3km",
    posElevation: "441m",
    negElevation: "441m",
  ...
  },
  {
    ...
    difficulty: "Medio-Facile",
    notes:
      "Escursione di difficoltà media. Sentieri facilmente percorribili. Non presenta particolari difficoltà se non la lunghezza del percorso e il dislivello.",
    time: "2h 50m",
    totDistance: "5.1km",
    posElevation: "800m",
    negElevation: "90m",
